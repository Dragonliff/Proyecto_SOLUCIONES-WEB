...
<%
    ...
    // 1. Obtener nombre de la sesión usando el objeto implícito 'session'
    ...
    // 2. Obtener la lista de asignaciones del request
    // Asumimos que esta lista YA contiene los datos del vehículo (Placa, Marca, Modelo)
...
<div class="container-fluid">
    ...
    <div class="container mt-4">
        ...
        <%
                ...
                // 4. Iterar y mostrar cada asignación
                for (asignaciones_conductor_vehiculo a : listaAsignaciones) {
                    
                    String estado = a.getEstado();
                    String estadoClase = estado != null && "Activa".equalsIgnoreCase(estado) ? "success" : "secondary";
        %>
            <div class="card mb-3 shadow-sm">
                <div class="card-body">
                    <h5 class="card-title text-primary">
                        **Placa: <%= a.getPlaca() != null ? a.getPlaca() : "N/D" %>** <span class="text-secondary">(<%= a.getTipoVehiculo() != null ? a.getTipoVehiculo() : "Tipo N/D" %>)</span>
                    </h5>
                    <p class="card-text mb-1"><strong>Marca:</strong> <%= a.getMarca() != null ? a.getMarca() : "N/D" %></p>
                    <p class="card-text mb-1"><strong>Modelo:</strong> <%= a.getModelo() != null ? a.getModelo() : "N/D" %></p>
                    <p class="card-text mb-1"><strong>Año:</strong> <%= a.getAnio() %></p>
                    <hr>
                    <p class="card-text">
                        <strong>Fecha Inicio:</strong> <%= a.getFechaInicio() != null ? a.getFechaInicio() : "-" %> <br>
                        <strong>Fecha Fin:</strong> <%= a.getFechaFin() != null ? a.getFechaFin() : "-" %> <br>
                        <strong>Estado:</strong> 
                        <span class="badge bg-<%= estadoClase %>"><%= estado != null ? estado : "N/D" %></span>
                    </p>
                </div>
            </div>
        <%
